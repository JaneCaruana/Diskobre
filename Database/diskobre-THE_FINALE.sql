...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2787121354ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=diskobre&table=estab_image">`diskobre`.`estab_image`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=diskobre&table=user">`diskobre`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=diskobre&table=operatingtime">`diskobre`.`operatingtime`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=diskobre&table=establishment">`diskobre`.`establishment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=diskobre&table=visits">`diskobre`.`visits`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=diskobre&table=category">`diskobre`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cemetery&table=user">`cemetery`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cemetery&table=booking">`cemetery`.`booking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=diskobre&table=subscription">`diskobre`.`subscription`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=diskobre&table=package">`diskobre`.`package`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="545b356f2f52586f453d292774562136">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="diskobre" targettable="establishment">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `establishment`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="diskobre" targettable="establishment">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `establishment`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="diskobre" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="diskobre" targettable="operatingtime">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `operatingtime`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="diskobre" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `operatingtime`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="diskobre" targettable="estab_image">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `estab_image`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="diskobre" targettable="estab_image">
                            <div class="action_content">
